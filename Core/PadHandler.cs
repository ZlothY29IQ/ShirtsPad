...
public class PadHandler : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        shirtsView.AddComponent<StandCameraHandler>().ShirtsView = shirtsView; // woah thats a lot of shirts view
    }
    ...
    private void Update()
    {
        ...
        if (standShirtName == null) standShirtName = GameObject.Find("GorillaShirts/Shirt Stand/UI/MainMenu/MainContainer/Text/Item/Main").GetComponent<TextMeshProUGUI>();
        if (standShirtCreator == null) standShirtCreator = GameObject.Find("GorillaShirts/Shirt Stand/UI/MainMenu/MainContainer/Text/Item/Body").GetComponent<TextMeshProUGUI>();
        if (standEquipText == null) standEquipText = GameObject.Find("GorillaShirts/Shirt Stand/UI/MainMenu/MainContainer/Buttons/ShirtEquip/Equip").GetComponent<TextMeshProUGUI>();
