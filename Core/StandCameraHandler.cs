...
public class StandCameraHandler : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            standCamera.transform.position = Vector3.Lerp(standCamera.transform.position, target.TransformPoint(standCameraOffset), Time.deltaTime * 5f);
    ...
    private void CreateStandCamera(Transform targetObject)
    {
        ...
        ShirtsView.GetComponent<Renderer>().material.mainTexture = rt;
    }
}